...
option1 = input('You are at a cross road. Where do you want to go? Type "left" or "right" ').lower()
if option1 == 'left':
    ...
    if option2 == "wait":
        option3 = input('You arrived at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose? ').lower()
        if option3 == 'red':
